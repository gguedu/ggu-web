    ...
    prose: {
      ...
      callout: {
        slots: {
          ...
          externalIcon: 'size-4 align-top absolute right-3 top-3 text-slate-500 pointer-events-none'
        }
      },
      card: {
        slots: {
          ...
          externalIcon: 'absolute right-3 top-3 size-4 text-slate-500 transition-colors group-hover:text-blue-300'
        }
      },
      cardGroup: {
      ...
      pre: {
        slots: {
          ...
          header: 'relative flex items-center gap-1.5 rounded-t-lg border border-white/10 border-b-0 bg-[#11161c] px-4 py-3',
      ...
      codeGroup: {
        slots: {
          ...
          indicator: 'absolute inset-y-2 left-0 w-(--reka-tabs-indicator-size) translate-x-(--reka-tabs-indicator-position) rounded-md bg-white/10 shadow-sm transition-[translate,width] duration-200',
          trigger: 'relative inline-flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-sm text-slate-400 transition-colors hover:bg-white/5 hover:text-slate-100 data-[state=active]:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-300/50',
      ...
      codeCollapse: {
        slots: {
          ...
          footer: 'absolute inset-x-px bottom-px flex h-16 items-center justify-center rounded-b-lg bg-gradient-to-t from-[#070b10] via-[#070b10]/90 to-transparent',
      ...
      collapsible: {
        slots: {
          ...
          trigger: 'group relative inline-flex items-center gap-1.5 rounded-md text-sm font-medium text-slate-300 transition-colors hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-300/50',
          triggerIcon: 'size-4 shrink-0 transition-transform duration-200 group-data-[state=open]:rotate-180',
          triggerLabel: 'truncate',
          content: 'mt-3 border-t border-white/10 pt-3 text-sm/7 text-slate-300 *:first:mt-0 *:last:mb-0'
        }
      },
      tabs: {
        slots: {
          ...
          indicator: 'absolute bottom-0 left-0 h-px w-(--reka-tabs-indicator-size) translate-x-(--reka-tabs-indicator-position) bg-blue-300 transition-[translate,width] duration-200',
          trigger: 'relative inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm text-slate-400 transition-colors hover:bg-white/5 hover:text-slate-100 data-[state=active]:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-300/50',
          triggerIcon: 'size-4 shrink-0',
          triggerLabel: 'truncate'
        }
      },
