...
<template>
  <section class="p-6 text-white max-w-4xl">
    ...
    <div class="space-y-4">
      ...
      <div>
        <label
          class="inline-flex items-center gap-2 px-3 py-2 rounded bg-[#2c2c2e] hover:bg-[#3a3a3d] cursor-pointer"
        >
      ...
      <div class="flex items-center gap-3">
        ...
        <button class="px-4 py-2 rounded bg-[#2c2c2e] hover:bg-[#3a3a3d]" @click="saveDraft">
          保存草稿
        </button>
        <button class="px-4 py-2 rounded bg-[#2c2c2e] hover:bg-[#3a3a3d]" @click="router.back()">
          取消
        </button>
      </div>
    </div>
